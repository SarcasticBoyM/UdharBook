...
export function statusBadgeClass(status: CustomerStatus | FollowUpStatus): string {
  const map: Record<CustomerStatus | FollowUpStatus, string> = {
    ...
    CALLBACK: "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300",
    FOLLOW_UP_REQUIRED: "bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300",
    ...
    PARTIAL_PAID: "bg-teal-100 text-teal-800 dark:bg-teal-900/40 dark:text-teal-300",
